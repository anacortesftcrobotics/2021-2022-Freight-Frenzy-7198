...
@TeleOp
//this one has turning
public class TestingTeleOp_Copy extends OpMode {
    ...
    public void controller1 () {
        ...
        if (-gamepad1.right_stick_x > 0.1) {
            if (rightDrivePower > -0.1 && rightDrivePower < 0.1) {
                rightDrivePower = 0.5;
                leftDrivePower = -0.5;
            } else {
                rightDrivePower = rightDrivePower + 0.3;
                leftDrivePower = leftDrivePower - 0.3;
            }
        }
        if (-gamepad1.right_stick_x < -0.1) {
            if (rightDrivePower > -0.1 && rightDrivePower < 0.1) {
